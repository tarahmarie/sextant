...
#
# VARIANT: No minimum word count filter. All texts are retained regardless
# of length. Used to test whether short Lovelace letters (< 500 words)
# surface any new findings. Compare results against the 500-word-minimum
# run archived in projects/shelley-lovelace-final-500w/.
...
# Set to 0 to retain all texts. The standard threshold is 500,
# based on Burrows (2007) and Koppel et al. (2007).
MIN_WORD_COUNT = 0
...
if skipped_files:
    ...
    print(f"\n✅ No minimum word count filter applied (MIN_WORD_COUNT = {MIN_WORD_COUNT}). All {file_count} files retained.\n")
